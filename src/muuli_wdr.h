...
const int IDC_SKINDIR = 10262;
const int IDC_SELSKINDIR = 10263;
...
const int IDC_SHOWPARTFILENUMBER = 10269;
...
const int IDC_UPNP_WEBSERVER_ENABLED = 10277;
const int IDC_WEBUPNPTCPPORT = 10278;
const int IDC_WEB_REFRESH_TIMEOUT = 10279;
const int IDC_WEB_GZIP = 10280;
const int IDC_ENABLE_WEB_LOW = 10281;
const int IDC_WEB_PASSWD = 10282;
const int IDC_WEB_PASSWD_LOW = 10283;
const int IDC_WEBTEMPLATE = 10284;
const int IDC_EXT_CONN_ACCEPT = 10285;
const int IDC_EXT_CONN_PASSWD = 10286;
const int IDC_EXT_CONN_IP = 10287;
const int IDC_EXT_CONN_TCP_PORT = 10288;
const int IDC_UPNP_EC_ENABLED = 10289;
...
const int ID_PREFSLISTCTRL = 10290;
const int ID_PREFS_OK_TOP = 10291;
const int ID_PREFS_CANCEL_TOP = 10292;
wxSizer *preferencesDlgTop( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_STATIC_TITLE = 10293;
const int IDC_TITLE = 10294;
const int IDC_STATIC_COMMENT = 10295;
const int IDC_COMMENT = 10296;
const int IDC_STATIC_INCOMING = 10297;
const int IDC_INCOMING = 10298;
const int IDC_BROWSE = 10299;
const int IDC_STATIC_PRIO = 10300;
const int IDC_PRIOCOMBO = 10301;
const int IDC_STATIC_COLOR = 10302;
const int ID_BOX_CATCOLOR = 10303;
const int IDC_CATCOLOR = 10304;
wxSizer *CategoriesEditWindow( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPLATTER = 10305;
wxSizer *transferDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SERVERINFO = 10306;
const int ID_BTN_RESET_SERVER = 10307;
wxSizer *ServerInfoLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOGVIEW = 10308;
const int ID_BTN_RESET = 10309;
wxSizer *aMuleLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_UPDATELIST = 10310;
const int IDC_SERVERLISTURL = 10311;
const int IDC_SERVERNAME = 10312;
const int IDC_IPADDRESS = 10313;
const int IDC_SPORT = 10314;
const int ID_ADDTOLIST = 10315;
const int IDC_ED2KDISCONNECT = 10316;
const int ID_SERVERLIST = 10317;
wxSizer *serverListDlgUp( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SRVLOG_NOTEBOOK = 10318;
wxSizer *serverListDlgDown( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOCALETEXT = 10319;
const int ID_OK = 10320;
const int ID_LOCALENEVERAGAIN = 10321;
wxSizer *LocaleWarning( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

extern wxSizer *kadSizer;
const int ID_UPDATEKADLIST = 10322;
const int IDC_NODESLISTURL = 10323;
const int ID_KADSCOPE = 10324;
const int ID_NODE_IP1 = 10325;
const int ID_NODE_IP2 = 10326;
const int ID_NODE_IP3 = 10327;
const int ID_NODE_IP4 = 10328;
const int ID_NODE_PORT = 10329;
const int ID_NODECONNECT = 10330;
const int ID_KNOWNNODECONNECT = 10331;
const int ID_KADDISCONNECT = 10332;
wxSizer *KadDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATICTEXT = 10333;
const int ID_ED2KINFO = 10334;
wxSizer *ED2K_Info( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_SEESHARES = 10335;
const int IDC_IPFCLIENTS = 10336;
const int IDC_IPFSERVERS = 10337;
const int IDC_IPFRELOAD = 10338;
const int IDC_IPFILTERURL = 10339;
const int IDC_IPFILTERUPDATE = 10340;
const int IDC_AUTOIPFILTER = 10341;
const int ID_IPFILTERLEVEL = 10342;
const int IDC_FILTERLAN = 10343;
const int IDC_PARANOID = 10344;
