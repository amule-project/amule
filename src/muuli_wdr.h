...
const int IDC_FILEBUFFERSIZE_STATIC = 10244;
const int IDC_FILEBUFFERSIZE = 10245;
const int IDC_QUEUESIZE_STATIC = 10246;
const int IDC_QUEUESIZE = 10247;
const int IDC_SERVERKEEPALIVE_LABEL = 10248;
const int IDC_SERVERKEEPALIVE = 10249;
wxSizer *PreferencesaMuleTweaksTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_PERCENT = 10250;
const int IDC_PROGBAR = 10251;
const int IDC_3DDEP = 10252;
const int IDC_3DDEPTH = 10253;
const int IDC_FLAT = 10254;
const int IDC_ROUND = 10255;
const int IDC_USESKIN = 10256;
const int IDC_SKINFILE = 10257;
const int IDC_SELSKINFILE = 10258;
const int IDC_AUTOSORT = 10259;
const int IDC_FED2KLH = 10260;
const int IDC_EXTCATINFO = 10261;
const int IDC_SHOWRATEONTITLE = 10262;
wxSizer *PreferencesGuiTweaksTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_NNS_HANDLING = 10263;
const int IDC_ENABLE_AUTO_FQS = 10264;
const int IDC_ENABLE_AUTO_HQRS = 10265;
const int IDC_HQR_VALUE = 10266;
const int IDC_AUTO_DROP_TIMER = 10267;
wxSizer *PreferencesSourcesDroppingTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_ENABLE_WEB = 10268;
const int IDC_WEB_PORT = 10269;
const int IDC_WEB_REFRESH_TIMEOUT = 10270;
const int IDC_WEB_GZIP = 10271;
const int IDC_ENABLE_WEB_LOW = 10272;
const int IDC_WEB_PASSWD = 10273;
const int IDC_WEB_PASSWD_LOW = 10274;
const int IDC_EXT_CONN_ACCEPT = 10275;
const int IDC_EXT_CONN_USETCP = 10276;
const int IDC_EXT_CONN_TCP_PORT = 10277;
const int IDC_EXT_CONN_PASSWD = 10278;
...
const int ID_PREFSLISTCTRL = 10279;
const int ID_PREFS_OK_TOP = 10280;
const int ID_PREFS_CANCEL_TOP = 10281;
wxSizer *preferencesDlgTop( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_STATIC_TITLE = 10282;
const int IDC_TITLE = 10283;
const int IDC_STATIC_COMMENT = 10284;
const int IDC_COMMENT = 10285;
const int IDC_STATIC_INCOMING = 10286;
const int IDC_INCOMING = 10287;
const int IDC_BROWSE = 10288;
const int IDC_STATIC_PRIO = 10289;
const int IDC_PRIOCOMBO = 10290;
const int IDC_STATIC_COLOR = 10291;
const int ID_BOX_CATCOLOR = 10292;
const int IDC_CATCOLOR = 10293;
wxSizer *CategoriesEditWindow( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPLATTER = 10294;
wxSizer *transferDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SERVERINFO = 10295;
const int ID_BTN_RESET_SERVER = 10296;
wxSizer *ServerInfoLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOGVIEW = 10297;
const int ID_BTN_RESET = 10298;
wxSizer *aMuleLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_UPDATELIST = 10299;
const int IDC_SERVERLISTURL = 10300;
const int IDC_SERVERNAME = 10301;
const int IDC_IPADDRESS = 10302;
const int IDC_SPORT = 10303;
const int ID_ADDTOLIST = 10304;
const int ID_SERVERLIST = 10305;
wxSizer *serverListDlgUp( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SRVLOG_NOTEBOOK = 10306;
wxSizer *serverListDlgDown( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOCALETEXT = 10307;
const int ID_LOCALENEVERAGAIN = 10308;
wxSizer *LocaleWarning( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_NODELIST = 10309;
const int ID_NODE_IP1 = 10310;
const int ID_NODE_IP2 = 10311;
const int ID_NODE_IP3 = 10312;
const int ID_NODE_IP4 = 10313;
const int ID_NODE_PORT = 10314;
const int ID_NODECONNECT = 10315;
const int ID_KNOWNNODECONNECT = 10316;
const int ID_KADSEARCHLIST = 10317;
wxSizer *KadDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_MYSERVINFO = 10318;
wxSizer *MyInfoLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_SEESHARES = 10319;
const int IDC_SPIN_PERM_FU = 10320;
const int IDC_SPIN_PERM_FG = 10321;
const int IDC_SPIN_PERM_FO = 10322;
const int IDC_SPIN_PERM_DU = 10323;
const int IDC_SPIN_PERM_DG = 10324;
const int IDC_SPIN_PERM_DO = 10325;
const int IDC_IPFONOFF = 10326;
const int IDC_IPFRELOAD = 10327;
const int IDC_AUTOIPFILTER = 10328;
const int IDC_IPFILTERURL = 10329;
const int IDC_IPFILTERUPDATE = 10330;
const int ID_IPFILTERLEVEL = 10331;
const int IDC_FILTER = 10332;
const int IDC_SECIDENT = 10333;
wxSizer *PreferencesSecurityTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_ONLINESIG = 10334;
const int ID_SPINCTRL = 10335;
const int IDC_OSDIR = 10336;
const int IDC_SELOSDIR = 10337;
wxSizer *PreferencesOnlineSigTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_MSGFILTER = 10338;
const int IDC_MSGFILTER_ALL = 10339;
const int IDC_MSGFILTER_NONFRIENDS = 10340;
const int IDC_MSGFILTER_NONSECURE = 10341;
const int IDC_MSGFILTER_WORD = 10342;
const int IDC_MSGWORD = 10343;
wxSizer *PreferencesMessagesTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROXY_ENABLE_PROXY = 10344;
const int ID_PROXY_TYPE = 10345;
const int ID_PROXY_NAME = 10346;
const int ID_PROXY_PORT = 10347;
const int ID_PROXY_ENABLE_PASSWORD = 10348;
const int ID_PROXY_USER = 10349;
const int ID_PROXY_PASSWORD = 10350;
const int ID_PROXY_AUTO_SERVER_CONNECT_WITHOUT_PROXY = 10351;
wxSizer *PreferencesProxyTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_REMOTE_HOST = 10352;
const int ID_REMOTE_PORT = 10353;
const int ID_EC_LOGIN = 10354;
const int ID_EC_PASSWD = 10355;
