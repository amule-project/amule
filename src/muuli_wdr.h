...
const int IDC_IPFILTERURL = 10338;
const int IDC_IPFILTERUPDATE = 10339;
const int ID_IPFILTERLEVEL = 10340;
const int IDC_FILTER = 10341;
...
const int IDC_OSUPDATE = 10344;
const int IDC_OSDIR = 10345;
const int IDC_SELOSDIR = 10346;
wxSizer *PreferencesOnlineSigTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_MSGFILTER = 10347;
const int IDC_MSGFILTER_ALL = 10348;
const int IDC_MSGFILTER_NONFRIENDS = 10349;
const int IDC_MSGFILTER_NONSECURE = 10350;
const int IDC_MSGFILTER_WORD = 10351;
const int IDC_MSGWORD = 10352;
wxSizer *PreferencesMessagesTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROXY_ENABLE_PROXY = 10353;
const int ID_PROXY_TYPE = 10354;
const int ID_PROXY_NAME = 10355;
const int ID_PROXY_PORT = 10356;
const int ID_PROXY_ENABLE_PASSWORD = 10357;
const int ID_PROXY_USER = 10358;
const int ID_PROXY_PASSWORD = 10359;
const int ID_PROXY_AUTO_SERVER_CONNECT_WITHOUT_PROXY = 10360;
wxSizer *PreferencesProxyTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_REMOTE_HOST = 10361;
const int ID_REMOTE_PORT = 10362;
const int ID_EC_LOGIN = 10363;
const int ID_EC_PASSWD = 10364;
const int ID_EC_SAVE = 10365;
wxSizer *CoreConnect( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_VERBOSEDEBUG = 10366;
const int ID_DEBUGCATS = 10367;
wxSizer *PreferencesDebug( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

extern wxSizer *IDC_CURJOB;
const int IDC_CONV_PB_LABEL = 10368;
const int IDC_CONV_PROZENT = 10369;
const int IDC_CONV_PB_CURRENT = 10370;
const int IDC_JOBLIST = 10371;
const int IDC_ADDITEM = 10372;
const int IDC_RETRY = 10373;
const int IDC_CONVREMOVE = 10374;
wxSizer *convertDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATICETXT = 10375;
const int ID_KADINFO = 10376;
