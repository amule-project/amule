...
const int ID_FILTER_TEXT = 10025;
const int ID_FILTER = 10026;
const int ID_FILTER_INVERT = 10027;
const int ID_FILTER_KNOWN = 10028;
...
const int ID_BTNSWWINDOW = 10033;
...
const int IDC_FCHECK = 10154;
const int ID_CUSTOMBROWSETEXT = 10155;
const int IDC_FCHECKSELF = 10156;
const int IDC_SELBROWSER = 10157;
const int IDC_FCHECKTABS = 10158;
...
const int IDC_AUTOCONNECT = 10180;
const int IDC_RECONN = 10181;
const int IDC_SHOWOVERHEAD = 10182;
wxSizer *PreferencesConnectionTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_REMOVEDEAD = 10183;
const int IDC_SERVERRETRIES = 10184;
const int IDC_RETRIES_LBL = 10185;
const int IDC_AUTOSERVER = 10186;
const int IDC_EDITADR = 10187;
const int IDC_UPDATESERVERCONNECT = 10188;
const int IDC_UPDATESERVERCLIENT = 10189;
const int IDC_SCORE = 10190;
const int IDC_SMARTIDCHECK = 10191;
const int IDC_SAFESERVERCONNECT = 10192;
const int IDC_AUTOCONNECTSTATICONLY = 10193;
const int IDC_MANUALSERVERHIGHPRIO = 10194;
wxSizer *PreferencesServerTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_ICH = 10195;
const int IDC_AICHTRUST = 10196;
const int IDC_ADDNEWFILESPAUSED = 10197;
const int IDC_DAP = 10198;
const int IDC_PREVIEWPRIO = 10199;
const int IDC_UAP = 10200;
const int IDC_FULLCHUNKTRANS = 10201;
const int IDC_STARTNEXTFILE = 10202;
const int IDC_STARTNEXTFILE_SAME = 10203;
const int IDC_SRCSEEDS = 10204;
const int IDC_METADATA = 10205;
const int IDC_CHUNKALLOC = 10206;
const int IDC_FULLALLOCATE = 10207;
...
const int ID_REMOTE_HOST = 10355;
const int ID_REMOTE_PORT = 10356;
const int ID_EC_LOGIN = 10357;
const int ID_EC_PASSWD = 10358;
const int ID_EC_SAVE = 10359;
wxSizer *CoreConnect( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_VERBOSEDEBUG = 10360;
const int ID_DEBUGCATS = 10361;
wxSizer *PreferencesDebug( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_CONV_PB_LABEL = 10362;
const int IDC_CONV_PROZENT = 10363;
const int IDC_CONV_PB_CURRENT = 10364;
const int IDC_JOBLIST = 10365;
const int IDC_ADDITEM = 10366;
const int IDC_RETRY = 10367;
const int IDC_CONVREMOVE = 10368;
...
const int ID_BUTTONCONNECT = 10369;
const int ID_BUTTONSERVERS = 10370;
const int ID_BUTTONKAD = 10371;
const int ID_BUTTONSEARCH = 10372;
const int ID_BUTTONTRANSFER = 10373;
const int ID_BUTTONSHARED = 10374;
const int ID_BUTTONMESSAGES = 10375;
const int ID_BUTTONSTATISTICS = 10376;
const int ID_BUTTONNEWPREFERENCES = 10377;
const int ID_BUTTONIMPORT = 10378;
const int ID_ABOUT = 10379;
