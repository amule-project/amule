IF (BUILT_UPNP)
	SET (WAIT_FOR_UPNP FALSE CACHE INTERNAL "Set if libupnp is needed to be built")
...
IF (NOT LIBUPNP_FOUND AND DOWNLOAD_AND_BUILD_DEPS)
	...
	EXTERNALPROJECT_ADD (UPNP
		...
		TEST_COMMAND ${CMAKE_COMMAND} ${amule_BINARY_DIR} -DBUILT_UPNP=TRUE
		STEP_TARGETS test
	)

	SET (WAIT_FOR_UPNP TRUE CACHE INTERNAL "Set if libupnp is needed to be built")
