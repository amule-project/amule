...
IF (WX_BUILT)
	SET (WAIT_FOR_WX FALSE CACHE INTERNAL "Set if wx is needed to be built")
	...
	SET (wxWidgets_CONFIG_EXECUTABLE ${BINARY_DIR}/wx-config CACHE FILEPATH "Location of wxWidgets library configuration provider binary (wx-config)." FORCE)
ENDIF (WX_BUILT)
...
IF (DOWNLOAD_AND_BUILD_DEPS AND NOT wxWidgets_CONFIG_EXECUTABLE AND NOT WX_BUILT)
	...
	EXTERNALPROJECT_ADD (wxWidgets
		...
		GIT_TAG v3.1.2
		GIT_PROGRESS TRUE
		CMAKE_ARGS "wxUSE_SOCKETS=TRUE CMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}"
		INSTALL_COMMAND ${CMAKE_COMMAND} ${amule_BINARY_DIR} -DWX_BUILT=TRUE
		TEST_COMMAND ${CMAKE_COMMAND} --build ${amule_BINARY_DIR}
	)

	SET (WAIT_FOR_WX TRUE CACHE INTERNAL "Set if wx is needed to be built")
