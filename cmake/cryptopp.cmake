IF (BUILT_CRYPTO)
	...
	SET (CRYTOPP_LIB_SEARCH_PATH ${SOURCE_DIR} CACHE PATH "Search hint for crypto++ library" FORCE)
ENDIF (BUILT_CRYPTO)
...
IF (NOT CRYPTOPP_CONFIG_FILE)
	...
	IF (NOT CRYPTOPP_INCLUDE_PREFIX)
		IF (EXISTS ${CRYPTOPP_HEADER_PATH}/cryptlib.h)
			SET (CRYPTOPP_INCLUDE_PREFIX ${CRYPTOPP_HEADER_PATH} CACHE STRING "cryptopp include prefix" FORCE)
...
IF (NOT CRYPTOPP_CONFIG_FILE AND DOWNLOAD_AND_BUILD_DEPS AND NOT BUILT_CRYPTO)
	EXTERNALPROJECT_ADD (CRYPTO
		GIT_REPOSITORY https://github.com/weidai11/cryptopp.git
		GIT_TAG CRYPTOPP_8_2_0
		GIT_PROGRESS TRUE
	...
	SET (WAIT_FOR_CRYPTO TRUE CACHE INTERNAL "Set if cryptopp is needed to be built")
ENDIF (NOT CRYPTOPP_CONFIG_FILE AND DOWNLOAD_AND_BUILD_DEPS AND NOT BUILT_CRYPTO)
