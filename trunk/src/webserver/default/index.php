  ...
  <tr>
	...
	<td class="tabs" align="center" width="30">&nbsp;		</td>
  	...
  	<td align="center" class="tabs" width="95">
  		<a href="#" onClick="self.location.href='?ses=2105603570&amp;w=server'; return false;">
  			<img src="cp_servers.gif"><br>
  			Server list
  		</a>
  	</td>
  	<td align="center" class="tabs" width="95">
  		<a href="#" onClick="self.location.href='downloads.php'; return false;">
  	...
  	<td align="center" class="tabs" width="95">
  		<a href="#" onClick="search.php'; return false;">
  	...
  	<td align="center" class="tabs" width="95">
  		...
  		<a href="#" onClick="shared.php'; return false;">
  			<img src="cp_shared.gif"><br>
  			Shared Files
  		</a>
  	<td align="center" class="tabs" width="110">
		<a href="#" onClick="statistics.php'; return false;">
			<img src="cp_stats.gif"><br>
  			Statistics</a>
  		<font color="#000000">|</font>

  		<a href="#" onClick="stat_graphs.php'; return false;">Graphs</a>
  	</td>
  	</td>
  	<td align="center" class="tabs" width="95">
  		<a href="#" onClick="preferences.php'; return false;">
