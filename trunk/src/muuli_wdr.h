...
const int IDC_FCHECKTABS = 10152;
wxSizer *PreferencesGeneralTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_DLIMIT_LBL = 10153;
const int IDC_MAXDOWN = 10154;
const int IDC_KBS1 = 10155;
const int IDC_ULIMIT_LBL = 10156;
const int IDC_MAXUP = 10157;
const int IDC_KBS4 = 10158;
const int IDC_SLOTALLOC = 10159;
const int IDC_DCAP_LBL = 10160;
const int IDC_DOWNLOAD_CAP = 10161;
const int IDC_KBS2 = 10162;
const int IDC_UCAP_LBL = 10163;
const int IDC_UPLOAD_CAP = 10164;
const int IDC_KBS3 = 10165;
const int IDC_PORT = 10166;
const int ID_TEXT_CLIENT_UDP_PORT = 10167;
const int IDC_UDPPORT = 10168;
const int IDC_UDPDISABLE = 10169;
const int IDC_MAXSRCHARD_LBL = 10170;
const int IDC_MAXSOURCEPERFILE = 10171;
const int IDC_MAXCONLABEL = 10172;
const int IDC_MAXCON = 10173;
const int IDC_AUTOCONNECT = 10174;
const int IDC_RECONN = 10175;
const int IDC_SHOWOVERHEAD = 10176;
wxSizer *PreferencesConnectionTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_REMOVEDEAD = 10177;
const int IDC_SERVERRETRIES = 10178;
const int IDC_RETRIES_LBL = 10179;
const int IDC_AUTOSERVER = 10180;
const int IDC_EDITADR = 10181;
const int IDC_UPDATESERVERCONNECT = 10182;
const int IDC_UPDATESERVERCLIENT = 10183;
const int IDC_SCORE = 10184;
const int IDC_SMARTIDCHECK = 10185;
const int IDC_SAFESERVERCONNECT = 10186;
const int IDC_AUTOCONNECTSTATICONLY = 10187;
const int IDC_MANUALSERVERHIGHPRIO = 10188;
wxSizer *PreferencesServerTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_ICH = 10189;
const int IDC_AICHTRUST = 10190;
const int IDC_ADDNEWFILESPAUSED = 10191;
const int IDC_DAP = 10192;
const int IDC_PREVIEWPRIO = 10193;
const int IDC_UAP = 10194;
const int IDC_FULLCHUNKTRANS = 10195;
const int IDC_STARTNEXTFILE = 10196;
const int IDC_STARTNEXTFILE_SAME = 10197;
const int IDC_SRCSEEDS = 10198;
const int IDC_METADATA = 10199;
const int IDC_CHUNKALLOC = 10200;
const int IDC_FULLALLOCATE = 10201;
const int IDC_CHECKDISKSPACE = 10202;
const int ID_MINDISKTEXT = 10203;
const int IDC_MINDISKSPACE = 10204;
wxSizer *PreferencesFilesTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_INCFILES = 10205;
const int IDC_SELINCDIR = 10206;
const int IDC_TEMPFILES = 10207;
const int IDC_SELTEMPDIR = 10208;
const int IDC_SHARESELECTOR = 10209;
const int IDC_SHAREHIDDENFILES = 10210;
const int IDC_VIDEOPLAYER = 10211;
const int IDC_BROWSEV = 10212;
const int IDC_VIDEOBACKUP = 10213;
wxSizer *PreferencesDirectoriesTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_SLIDERINFO = 10214;
const int IDC_SLIDER = 10215;
const int IDC_SLIDERINFO3 = 10216;
const int IDC_SLIDER3 = 10217;
const int IDC_SLIDERINFO4 = 10218;
const int IDC_SLIDER4 = 10219;
const int IDC_PREFCOLORS = 10220;
const int IDC_COLORSELECTOR = 10221;
const int IDC_COLOR_BUTTON = 10222;
const int IDC_SLIDERINFO2 = 10223;
const int IDC_SLIDER2 = 10224;
wxSizer *PreferencesStatisticsTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_CB_TBN_USESOUND = 10225;
const int IDC_EDIT_TBN_WAVFILE = 10226;
const int IDC_BTN_BROWSE_WAV = 10227;
const int IDC_CB_TBN_ONLOG = 10228;
const int IDC_CB_TBN_ONCHAT = 10229;
const int IDC_CB_TBN_POP_ALWAYS = 10230;
const int IDC_CB_TBN_ONDOWNLOAD = 10231;
const int IDC_CB_TBN_ONNEWVERSION = 10232;
const int IDC_CB_TBN_IMPORTATNT = 10233;
const int IDC_SENDMAIL = 10234;
const int IDC_SMTP = 10235;
const int IDC_EMAIL = 10236;
wxSizer *PreferencesNotifyTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_WARNING = 10237;
const int IDC_STATIC = 10238;
const int IDC_MAXCON5SECLABEL = 10239;
const int IDC_MAXCON5SEC = 10240;
const int IDC_FILEBUFFERSIZE_STATIC = 10241;
const int IDC_FILEBUFFERSIZE = 10242;
const int IDC_QUEUESIZE_STATIC = 10243;
const int IDC_QUEUESIZE = 10244;
const int IDC_SERVERKEEPALIVE_LABEL = 10245;
const int IDC_SERVERKEEPALIVE = 10246;
wxSizer *PreferencesaMuleTweaksTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_PERCENT = 10247;
const int IDC_PROGBAR = 10248;
const int IDC_3DDEP = 10249;
const int IDC_3DDEPTH = 10250;
const int IDC_FLAT = 10251;
const int IDC_ROUND = 10252;
const int IDC_USESKIN = 10253;
const int IDC_SKINFILE = 10254;
const int IDC_SELSKINFILE = 10255;
const int IDC_AUTOSORT = 10256;
const int IDC_FED2KLH = 10257;
const int IDC_EXTCATINFO = 10258;
const int IDC_SHOWRATEONTITLE = 10259;
wxSizer *PreferencesGuiTweaksTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_NNS_HANDLING = 10260;
const int IDC_ENABLE_AUTO_FQS = 10261;
const int IDC_ENABLE_AUTO_HQRS = 10262;
const int IDC_HQR_VALUE = 10263;
const int IDC_AUTO_DROP_TIMER = 10264;
wxSizer *PreferencesSourcesDroppingTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_ENABLE_WEB = 10265;
const int IDC_WEB_PORT = 10266;
const int IDC_WEB_REFRESH_TIMEOUT = 10267;
const int IDC_WEB_GZIP = 10268;
const int IDC_ENABLE_WEB_LOW = 10269;
const int IDC_WEB_PASSWD = 10270;
const int IDC_WEB_PASSWD_LOW = 10271;
const int IDC_EXT_CONN_ACCEPT = 10272;
const int IDC_EXT_CONN_USETCP = 10273;
const int IDC_EXT_CONN_TCP_PORT = 10274;
const int IDC_EXT_CONN_PASSWD = 10275;
...
const int ID_PREFSLISTCTRL = 10276;
const int ID_PREFS_OK_TOP = 10277;
const int ID_PREFS_CANCEL_TOP = 10278;
wxSizer *preferencesDlgTop( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_STATIC_TITLE = 10279;
const int IDC_TITLE = 10280;
const int IDC_STATIC_COMMENT = 10281;
const int IDC_COMMENT = 10282;
const int IDC_STATIC_INCOMING = 10283;
const int IDC_INCOMING = 10284;
const int IDC_BROWSE = 10285;
const int IDC_STATIC_PRIO = 10286;
const int IDC_PRIOCOMBO = 10287;
const int IDC_STATIC_COLOR = 10288;
const int ID_BOX_CATCOLOR = 10289;
const int IDC_CATCOLOR = 10290;
wxSizer *CategoriesEditWindow( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPLATTER = 10291;
wxSizer *transferDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SERVERINFO = 10292;
const int ID_BTN_RESET_SERVER = 10293;
wxSizer *ServerInfoLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOGVIEW = 10294;
const int ID_BTN_RESET = 10295;
wxSizer *aMuleLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_UPDATELIST = 10296;
const int IDC_SERVERLISTURL = 10297;
const int IDC_SERVERNAME = 10298;
const int IDC_IPADDRESS = 10299;
const int IDC_SPORT = 10300;
const int ID_ADDTOLIST = 10301;
const int ID_SERVERLIST = 10302;
wxSizer *serverListDlgUp( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SRVLOG_NOTEBOOK = 10303;
wxSizer *serverListDlgDown( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOCALETEXT = 10304;
const int ID_LOCALENEVERAGAIN = 10305;
wxSizer *LocaleWarning( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_NODELIST = 10306;
const int ID_NODE_IP1 = 10307;
const int ID_NODE_IP2 = 10308;
const int ID_NODE_IP3 = 10309;
const int ID_NODE_IP4 = 10310;
const int ID_NODE_PORT = 10311;
const int ID_NODECONNECT = 10312;
const int ID_KNOWNNODECONNECT = 10313;
const int ID_KADSEARCHLIST = 10314;
wxSizer *KadDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_MYSERVINFO = 10315;
wxSizer *MyInfoLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_SEESHARES = 10316;
const int IDC_SPIN_PERM_FU = 10317;
const int IDC_SPIN_PERM_FG = 10318;
const int IDC_SPIN_PERM_FO = 10319;
const int IDC_SPIN_PERM_DU = 10320;
const int IDC_SPIN_PERM_DG = 10321;
const int IDC_SPIN_PERM_DO = 10322;
const int IDC_IPFONOFF = 10323;
const int IDC_IPFRELOAD = 10324;
const int IDC_AUTOIPFILTER = 10325;
const int IDC_IPFILTERURL = 10326;
const int IDC_IPFILTERUPDATE = 10327;
const int ID_IPFILTERLEVEL = 10328;
const int IDC_FILTER = 10329;
const int IDC_SECIDENT = 10330;
wxSizer *PreferencesSecurityTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_ONLINESIG = 10331;
const int IDC_OSUPDATE = 10332;
const int IDC_OSDIR = 10333;
const int IDC_SELOSDIR = 10334;
wxSizer *PreferencesOnlineSigTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_MSGFILTER = 10335;
const int IDC_MSGFILTER_ALL = 10336;
const int IDC_MSGFILTER_NONFRIENDS = 10337;
const int IDC_MSGFILTER_NONSECURE = 10338;
const int IDC_MSGFILTER_WORD = 10339;
const int IDC_MSGWORD = 10340;
wxSizer *PreferencesMessagesTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROXY_ENABLE_PROXY = 10341;
const int ID_PROXY_TYPE = 10342;
const int ID_PROXY_NAME = 10343;
const int ID_PROXY_PORT = 10344;
const int ID_PROXY_ENABLE_PASSWORD = 10345;
const int ID_PROXY_USER = 10346;
const int ID_PROXY_PASSWORD = 10347;
const int ID_PROXY_AUTO_SERVER_CONNECT_WITHOUT_PROXY = 10348;
wxSizer *PreferencesProxyTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_REMOTE_HOST = 10349;
const int ID_REMOTE_PORT = 10350;
const int ID_EC_LOGIN = 10351;
const int ID_EC_PASSWD = 10352;
const int ID_EC_SAVE = 10353;
wxSizer *CoreConnect( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_VERBOSEDEBUG = 10354;
const int ID_DEBUGCATS = 10355;
...
const int ID_BUTTONCONNECT = 10356;
const int ID_BUTTONSERVERS = 10357;
const int ID_BUTTONKAD = 10358;
const int ID_BUTTONSEARCH = 10359;
const int ID_BUTTONTRANSFER = 10360;
const int ID_BUTTONSHARED = 10361;
const int ID_BUTTONMESSAGES = 10362;
const int ID_BUTTONSTATISTICS = 10363;
const int ID_BUTTONNEWPREFERENCES = 10364;
const int ID_ABOUT = 10365;
