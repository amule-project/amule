...
const int IDC_TRANSFERRED = 10067;
...
const int IDC_STRANSFERRED = 10108;
const int IDC_STRANSFERRED2 = 10109;
...
const int IDC_USESKINFILES = 10261;
const int IDC_SKIN = 10262;
...
const int IDC_SHOWPARTFILENUMBER = 10268;
...
const int IDC_WEBUPNPTCPPORT = 10277;
...
const int IDC_WEBTEMPLATE = 10283;
const int IDC_EXT_CONN_ACCEPT = 10284;
const int IDC_EXT_CONN_PASSWD = 10285;
const int IDC_EXT_CONN_IP = 10286;
const int IDC_EXT_CONN_TCP_PORT = 10287;
const int IDC_UPNP_EC_ENABLED = 10288;
...
const int ID_PREFSLISTCTRL = 10289;
const int ID_PREFS_OK_TOP = 10290;
const int ID_PREFS_CANCEL_TOP = 10291;
wxSizer *preferencesDlgTop( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_STATIC_TITLE = 10292;
const int IDC_TITLE = 10293;
const int IDC_STATIC_COMMENT = 10294;
const int IDC_COMMENT = 10295;
const int IDC_STATIC_INCOMING = 10296;
const int IDC_INCOMING = 10297;
const int IDC_BROWSE = 10298;
const int IDC_STATIC_PRIO = 10299;
const int IDC_PRIOCOMBO = 10300;
const int IDC_STATIC_COLOR = 10301;
const int ID_BOX_CATCOLOR = 10302;
const int IDC_CATCOLOR = 10303;
wxSizer *CategoriesEditWindow( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SPLATTER = 10304;
wxSizer *transferDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SERVERINFO = 10305;
const int ID_BTN_RESET_SERVER = 10306;
wxSizer *ServerInfoLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOGVIEW = 10307;
const int ID_BTN_RESET = 10308;
wxSizer *aMuleLog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_UPDATELIST = 10309;
const int IDC_SERVERLISTURL = 10310;
const int IDC_SERVERNAME = 10311;
const int IDC_IPADDRESS = 10312;
const int IDC_SPORT = 10313;
const int ID_ADDTOLIST = 10314;
const int IDC_ED2KDISCONNECT = 10315;
const int ID_SERVERLIST = 10316;
wxSizer *serverListDlgUp( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_SRVLOG_NOTEBOOK = 10317;
wxSizer *serverListDlgDown( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_LOCALETEXT = 10318;
const int ID_OK = 10319;
const int ID_LOCALENEVERAGAIN = 10320;
wxSizer *LocaleWarning( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

extern wxSizer *kadSizer;
const int ID_UPDATEKADLIST = 10321;
const int IDC_NODESLISTURL = 10322;
const int ID_KADSCOPE = 10323;
const int ID_NODE_IP1 = 10324;
const int ID_NODE_IP2 = 10325;
const int ID_NODE_IP3 = 10326;
const int ID_NODE_IP4 = 10327;
const int ID_NODE_PORT = 10328;
const int ID_NODECONNECT = 10329;
const int ID_KNOWNNODECONNECT = 10330;
const int ID_KADDISCONNECT = 10331;
wxSizer *KadDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATICTEXT = 10332;
const int ID_ED2KINFO = 10333;
wxSizer *ED2K_Info( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_SUPPORT_PO = 10334;
const int IDC_ENABLE_PO_OUTGOING = 10335;
const int IDC_ENFORCE_PO_INCOMING = 10336;
const int IDC_SEESHARES = 10337;
const int IDC_IPFCLIENTS = 10338;
const int IDC_IPFSERVERS = 10339;
const int IDC_IPFRELOAD = 10340;
const int IDC_IPFILTERURL = 10341;
const int IDC_IPFILTERUPDATE = 10342;
const int IDC_AUTOIPFILTER = 10343;
const int ID_IPFILTERLEVEL = 10344;
const int IDC_FILTERLAN = 10345;
const int IDC_PARANOID = 10346;
const int IDC_SECIDENT = 10347;
wxSizer *PreferencesSecurityTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_ONLINESIG = 10348;
const int IDC_OSUPDATE = 10349;
const int IDC_OSDIR = 10350;
const int IDC_SELOSDIR = 10351;
wxSizer *PreferencesOnlineSigTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int IDC_MSGFILTER = 10352;
const int IDC_MSGFILTER_ALL = 10353;
const int IDC_MSGFILTER_NONFRIENDS = 10354;
const int IDC_MSGFILTER_NONSECURE = 10355;
const int IDC_MSGFILTER_WORD = 10356;
const int IDC_MSGWORD = 10357;
const int IDC_FILTERCOMMENTS = 10358;
const int IDC_COMMENTWORD = 10359;
wxSizer *PreferencesMessagesTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_PROXY_ENABLE_PROXY = 10360;
const int ID_PROXY_TYPE = 10361;
const int ID_PROXY_NAME = 10362;
const int ID_PROXY_PORT = 10363;
const int ID_PROXY_ENABLE_PASSWORD = 10364;
const int ID_PROXY_USER = 10365;
const int ID_PROXY_PASSWORD = 10366;
const int ID_PROXY_AUTO_SERVER_CONNECT_WITHOUT_PROXY = 10367;
wxSizer *PreferencesProxyTab( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_REMOTE_HOST = 10368;
const int ID_REMOTE_PORT = 10369;
const int ID_EC_LOGIN = 10370;
const int ID_EC_PASSWD = 10371;
const int ID_EC_SAVE = 10372;
wxSizer *CoreConnect( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_VERBOSEDEBUG = 10373;
const int ID_DEBUGCATS = 10374;
wxSizer *PreferencesDebug( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

extern wxSizer *IDC_CURJOB;
const int IDC_CONV_PB_LABEL = 10375;
const int IDC_CONV_PROZENT = 10376;
const int IDC_CONV_PB_CURRENT = 10377;
const int IDC_JOBLIST = 10378;
const int IDC_ADDITEM = 10379;
const int IDC_RETRY = 10380;
const int IDC_CONVREMOVE = 10381;
wxSizer *convertDlg( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

const int ID_STATICETXT = 10382;
const int ID_KADINFO = 10383;
wxSizer *Kad_Info( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

extern wxSizer *netSizer;
const int ID_NETNOTEBOOK = 10384;
wxSizer *NetDialog( wxWindow *parent, bool call_fit = TRUE, bool set_sizer = TRUE );

extern wxSizer *IDC_PREFS_EVENTS_PAGE;
const int IDC_EVENTLIST = 10385;
...
const int ID_BUTTONCONNECT = 10386;
const int ID_BUTTONNETWORKS = 10387;
const int ID_BUTTONSEARCH = 10388;
const int ID_BUTTONTRANSFER = 10389;
const int ID_BUTTONSHARED = 10390;
const int ID_BUTTONMESSAGES = 10391;
const int ID_BUTTONSTATISTICS = 10392;
const int ID_BUTTONNEWPREFERENCES = 10393;
const int ID_BUTTONIMPORT = 10394;
const int ID_ABOUT = 10395;
