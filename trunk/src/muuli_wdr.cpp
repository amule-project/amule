...
wxSizer *PreferencesaMuleTweaksTab( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxCheckBox *item11 = new wxCheckBox( parent, IDC_AUTOTAKEED2KLINKS, _("Autotake ED2K Links only during runtime"), wxDefaultPosition, wxDefaultSize, 0 );
    item11->SetValue( TRUE );
    item1->Add( item11, 0, wxADJUST_MINSIZE|wxALIGN_CENTER_VERTICAL, 5 );

    wxCheckBox *item12 = new wxCheckBox( parent, IDC_SHOWRATEONTITLE, _("Show transfer rates on title"), wxDefaultPosition, wxDefaultSize, 0 );
    item12->SetValue( TRUE );
    ...
    wxSlider *item16 = new wxSlider( parent, IDC_QUEUESIZE, 50, 5, 100, wxDefaultPosition, wxSize(100,-1), wxSL_HORIZONTAL );
    ...
    item1->Add( item17, 0, wxADJUST_MINSIZE|wxALIGN_CENTER_VERTICAL, 5 );
